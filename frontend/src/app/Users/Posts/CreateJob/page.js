...
const CreateJob = () => {
    ...
    useEffect(() => {
        ...
        const fetchRecruiterData = async () => {
            try {
                ...
                setLoading(false);
                toast.error("Failed to load recruiter data. Please ensure backend is running on port 8000.");
            }
        };
        fetchRecruiterData();
    }, [dispatch]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post(`${API_BASE_URL}/createjob/`, finalFormData, { withCredentials: true });
